...
RSpec.describe "/discounts", type: :request do
  ...
  # DiscountsController, or in your router and rack
  ...
  describe "GET /index" do
    it "renders a successful response" do
      ...
      get discounts_url, headers: valid_headers, as: :json
  ...
  describe "POST /create" do
    ...
    context "with invalid parameters" do
      it "does not create a new Discount" do
        expect {
          post discounts_url,
               params: { discount: invalid_attributes }, as: :json
        }.to change(Discount, :count).by(0)
      end

      it "renders a JSON response with errors for the new discount" do
        post discounts_url,
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "renders a JSON response with the discount" do
        discount = Discount.create! valid_attributes
        patch discount_url(discount),
              params: { discount: new_attributes }, headers: valid_headers, as: :json
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the discount" do
        discount = Discount.create! valid_attributes
        patch discount_url(discount),
              params: { discount: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested discount" do
      discount = Discount.create! valid_attributes
      expect {
        delete discount_url(discount), headers: valid_headers, as: :json
      }.to change(Discount, :count).by(-1)
    end
  end
end
